...
class UsuariosModel extends Mysql{
    public $id, $clave, $nombre, $cedula, $usuario, $correo, $rol;
    ...
    public function insertarUsuarios(string $nombre, string $usuario, string $cedula, string $correo, string $clave, string $rol)
    {
        $return = "";
        $this->nombre = $nombre;
        $this->cedula = $cedula;
        ...
        if (empty($result)) {
            $query = "INSERT INTO usuarios(nombre, usuario, cedula, correo, clave, rol) VALUES (?,?,?,?,?,?)";
            $data = array($this->nombre, $this->usuario, $this->cedula, $this->correo, $this->clave, $this->rol);
    ...
    public function actualizarUsuarios(string $nombre, string $usuario,string $cedula, string $correo, string $rol, int $id)
    {
        $return = "";
        $this->nombre = $nombre;
        $this->usuario = $usuario;
        ...
        $this->rol = $rol;
        $this->id = $id;
        $query = "UPDATE usuarios SET nombre=?, usuario=?,cedula=?, correo=?, rol=? WHERE id=?";
        $data = array($this->nombre, $this->usuario, $this->cedula, $this->correo,$this->rol, $this->id);
